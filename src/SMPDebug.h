...
namespace hdt
{
	...
	// subcommand (e.g. "list"); buffer2..buffer6 are its optional args (e.g. "gear", or "xml" then the
	// "fix xml" flags). a_thisObj is the console's targeted reference, used only by "dumptree"; pass the
	// player or nullptr from the menu. Returns true when the command was handled.
